...
export function Card({ children, className = '' }: { children: ReactNode, className?: string }) {
    return (
        <div className={`shadow-xl rounded-lg bg-zinc-100/90 text-white ${className}`}>
            {children}
        </div>
    )
}
...
export function CardHeaderGrab({ 
    ...
    return (
        <div 
            {...dragHandleProps}
            className='py-1 text-primary bg-zinc-100 cursor-grab flex justify-center items-center rounded-t-lg'
        >
